...
#define REDIS_BGDS_INSERT "LPUSH bgds:%"PRIu64" bgd:%"PRIu64
...
#define REDIS_INODES_INSERT "LPUSH inodes:%"PRIu64" inode:%"PRIu64
...
#define REDIS_EXTENTS_INSERT "LPUSH extents:%"PRIu64" extent:%"PRIu64

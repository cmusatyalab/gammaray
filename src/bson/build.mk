...
bsonsrc = $(srcdir)/src/bson

lib_libbson_la_SOURCES = $(bsonsrc)/bson-encoder.c \
						 $(bsonsrc)/bson-decoder.c \
						 $(bsonsrc)/bson-util.c
lib_libbson_la_LIBADD = $(libdir)/libcolor.la $(libdir)/libutil.la

bin_tools_bson_printer_SOURCES = $(bsonsrc)/bson_printer.c
bin_tools_bson_printer_LDADD = $(libdir)/libbson.la $(libdir)/libcolor.la

bin_test_bson_test_SOURCES = $(bsonsrc)/bson_test.c

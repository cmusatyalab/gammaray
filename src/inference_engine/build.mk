...
inferencesrc = $(srcdir)/src/inference_engine
...
lib_libqemucommon_la_SOURCES = $(inferencesrc)/qemu_common.c
lib_libqemucommon_la_LIBADD = $(libdir)/libbson.la

bin_async_queuer_SOURCES = $(inferencesrc)/async_queuer.c
...
bin_inference_engine_SOURCES = $(inferencesrc)/inference_engine.c \
							   $(inferencesrc)/deep_inspection.c
